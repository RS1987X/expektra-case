...
- Follow-up action: run permutation-importance analysis separately for day-ahead and two-day-ahead forecast slices as well, so feature relevance can be compared across shorter and longer horizons instead of only one aggregate view.
